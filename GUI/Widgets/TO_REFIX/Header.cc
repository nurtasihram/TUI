...
#endif
#if (HEADER_SUPPORT_DRAG)
static void _OnMouseOver(Header *pObj, WM_PARAM *pData) {
...
#endif
#if (HEADER_SUPPORT_DRAG)
static void _OnTouch(Header *pObj, WM_PARAM *pData) {
	int Notification;
	const PidState *pState = (const PidState *)*pData;
	if (pState) {
...
#endif
static void _HEADER_Callback(WM_PARAM *pData) {
