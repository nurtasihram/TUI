...
static void _ForwardPIDMsgToOwner(Menu *pObj, WM_MSG *pMsg) {
	if (_IsTopLevelMenu(pObj))
		return;
...
static void _OnMenu(Menu *pObj, WM_MSG *pMsg) {
...
//		pObj->DrawUp();
//}
//static void _MENU_Callback(WM_MSG *pMsg) {
//	auto pObj = (Menu *)pMsg->pWin;
